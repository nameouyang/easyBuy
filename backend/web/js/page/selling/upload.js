    ...
    $.extend({
        initThirdPlugins: function () {
            if ($('#file_data').length > 0) {
                $("#file_data").fileinput({language: 'zh', showUpload: false, showRemove: false, allowedFileExtensions: ['png','jpg'], theme: 'fa', showPreview: false, uploadUrl: '/selling/file-uploader'});
                $('#file_data').on('fileuploaded', function (event, data, previewId, index) {
                    ...
                    if (response.success)
                    {
                        ...
                        $("#upload-license-a").attr('href',response.file);
            ...
            if ($('#file_data_contract').length > 0) {
                $("#file_data_contract").fileinput({
                    ...
                    theme: 'fa',
                    showPreview: false,
                    uploadUrl: '/selling/file-uploader'
                });
