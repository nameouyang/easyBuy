$(function(){
    ...
    $("#inout-stock").click(function () {
        ...
        var srvType = $("input[name=srv-type]").val();
        var warehouseType = $("input[name=warehouse-type]").val();
        var excIsSerial;
        ...
        $inTrRow.each(function () {
            ...
            inStockGoods.price = $("input[name=in-stock-price]").first().val();
        ...
        if(srvType==='HH'){
            $outTrRow.each(function () {
                ...
                outStockGoods.orgPrice = $("input[name=org-price]").first().val();
        ...
        $.post("/aftersale/stock/in-out-stock",
            {
                order_no: orderNo,
                org_id: orgId,
                srv_type: srvType,
