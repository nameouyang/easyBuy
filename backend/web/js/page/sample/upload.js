    ...
    $.extend({
        initThirdPlugins: function (){
            if ($('#file_data').length > 0) {
                $("#file_data").fileinput({language: 'zh', showUpload: false, showRemove: false, allowedFileExtensions: ['jpg', 'jpeg', 'png', 'bmp', 'gif'], theme: 'fa', showPreview: false, uploadUrl: '/sample/info/upload'});
