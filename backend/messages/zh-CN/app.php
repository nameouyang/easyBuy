...
return [
    ...
    'Search for answer'=>'按回答搜索',
    'Search for question'=>'按提问搜索',
    'Search for name'=>'按名称搜索',
    'Search for description'=>'按描述搜索',
    'Search for sort order'=>'按排序搜索',
    'Search for url'=>'按URL搜索',
    'Search for logo'=>'按LOGO搜索',
