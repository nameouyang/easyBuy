                    ...
                    <tr>
                        ...
                        <td class="operate">
                            <div>
                                ...
                                <?php if ($item->payment_method == \common\models\Order::PAYMENT_METHOD_PAY && $item->payment_status == \common\models\Order::PAYMENT_STATUS_UNPAID) { ?><a class="btn" href="<?= Yii::$app->urlManager->createUrl(['cart/pay', 'sn' => $item->sn]) ?>" target="_blank">去付款</a><?php } ?>
                            </div>
                            <div>
