<div class="hd_main cle">
    <div class="logo">
        <p>
            <a href="<?= Yii::$app->homeUrl ?>" class="easy_buy_logo">商城</a>
    ...
    <div class="head_search_hot">
        <span>热搜榜：</span>
        <a class="red" href="<?= Yii::$app->urlManager->createUrl(['product/search', 'keyword' => 'iPhone']) ?>" target="_blank">iPhone</a>
    ...
    <div class="intro">
        <ul>
            <li class="no1"><a href="#" target="_blank"><h4>正品保证</h4><p>买家帮你承保</p></a></li>
